...
class CreateRemindersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('reminders', function (Blueprint $table) {
            $table->increments('id');
            $table->unsignedInteger('file_id')->nullable(); //FK
            $table->foreign('file_id')->references('id')->on('lawsuits');
            $table->integer('lawsuit_type')->nullable();//color from lawsuittype_lookups
            ...
            $table->integer('event_id')->nullable(); //FK task,procedure,order
