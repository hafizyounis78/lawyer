...
class MenuSeeder extends Seeder
{
    ...
    {
        $menu = new \App\Menu();
        $menu->menu_name = "الملفات القضائية";
        $menu->menu_order = 1;
        $menu->menu_icon = "icon-bulb";
        $menu->save();

        $menu = new \App\Menu();
        $menu->menu_name = "المهام";
        $menu->menu_order = 2;
        $menu->menu_icon = "icon-briefcase";
        $menu->save();

        $menu = new \App\Menu();
        $menu->menu_name = "الموظفين";
        $menu->menu_order = 3;
        $menu->menu_icon = "icon-diamond";
        $menu->save();

        $menu = new \App\Menu();
        $menu->menu_name = "ادارة التقييم";
        $menu->menu_order = 4;
        $menu->menu_icon = "icon-wallet";
        $menu->save();

        $menu = new \App\Menu();
        $menu->menu_name = "ادارة الصلاحيات";
        $menu->menu_order = 5;
        $menu->menu_icon = "icon-bar-chart";
        $menu->save();

        $menu = new \App\Menu();
        $menu->menu_name = "اعدادات النظام";
        $menu->menu_order = 6;
        $menu->menu_icon = "fa fa-cogs";
        $menu->save();

        $menu = new \App\Menu();
        $menu->menu_name = "االتقارير";
        $menu->menu_order = 7;
