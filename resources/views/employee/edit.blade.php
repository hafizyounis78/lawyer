                ...
                <div class="form-body">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon input-group col-md-12">
                                ...
                                <input id="email" name="email" type="email" class="form-control"
                                       placeholder="البريد الإلكتروني" data-id="{{$emp->email}}"
                                       value="{{$emp->email}}"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="job_title" name="job_title" class="form-control select2">
                                <option value="">اختر قيمة</option>
                                <?php
                                $selected = '';
                                foreach ($jobs as $job) {
                                    $selected = '';
                                    if ($emp->job_title == $job->id)
                                        $selected = 'selected="selected"';
                                    echo '<option value="' . $job->id . '"' . $selected . ' >' . $job->desc . '</option>';
                                }
                                ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input name="start_date" class="form-control form-control-inline  date-picker" size="16"
                                   type="text" value="{{$emp->start_date}}" data-date-format="yyyy-mm-dd"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input name="end_date" class="form-control form-control-inline  date-picker" size="16"
                                   type="text" value="{{$emp->end_date}}" data-date-format="yyyy-mm-dd"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="districts_id" name="districts_id" class="form-control select2">
                                <option value="">اختر قيمة</option>
                                <?php
                                $selected = '';
                                foreach ($districts as $district) {
                                    $selected = '';
                                    if ($emp->districts_id == $district->id)
                                        $selected = 'selected="selected"';
                                    echo '<option value="' . $district->id . '"' . $selected . ' >' . $district->desc . '</option>';
                                }
                                ?>
                            </select>
                        </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-success">
                    ...
                    <div class="form-body">
                        ...
                        <input type="hidden" id="hdn_emp_id" name="hdn_emp_id" value="{{$emp->emp_id}}"/>
