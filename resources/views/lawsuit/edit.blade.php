...
@section('content')
    ...
    <div class="page-content">
                ...
                <div class="form-body">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <input name="file_no" type="text"
                                               ...
                                               placeholder="" value="{{$one_lawsuit->file_no}}">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <input name="police_file_no" type="text" class="form-control input-left"
                                               placeholder="" value="{{$one_lawsuit->police_file_no}}">
                                        <span class="input-group-addon input-right">
                                                                            <i class="fa fa-cog"></i>
                                                                        </span>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <input name="court_file_no" type="text"
                                               class="form-control input-left"
                                               placeholder="" value="{{$one_lawsuit->court_file_no}}">
                                        <span class="input-group-addon input-right">
                                                                            <i class="fa fa-cog"></i>
                                                                        </span>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <input name="appeal_file_no" type="text" class="form-control input-left"
                                               placeholder="" value="{{$one_lawsuit->appeal_file_no}}">
                                        <span class="input-group-addon input-right">
                                                                            <i class="fa fa-cog"></i>
                                                                        </span>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="input-icon">
                                        ...
                                        <input name="suit_type" type="text" class="form-control input"
                                               placeholder="تفصيل الدعوى" value="{{$one_lawsuit->suit_type}}"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <input name="veto_file_no" type="text" class="form-control input-left"
                                               placeholder="" value="{{$one_lawsuit->veto_file_no}}">
                                        <span class="input-group-addon input-right">
                                                                            <i class="fa fa-cog"></i>
                                                                        </span>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <select id="currency" name="currency" class="form-control select2">
                                            <option value="1" {{($one_lawsuit->currency==0)?"selected='selected'":""}}>
                                                اختر قيمة..
                                            </option>
                                            <option value="1" {{($one_lawsuit->currency==1)?"selected='selected'":""}}>
                                                شيكل NIS
                                            </option>
                                            <option value="2" {{($one_lawsuit->currency==2)?"selected='selected'":""}}>
                                                دولار US
                                            </option>
                                            <option value="3" {{($one_lawsuit->currency==3)?"selected='selected'":""}}>
                                                دينار JOD
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon input-group col-md-12">
                                        ...
                                        <input name="lawsuit_value2" type="text" class="form-control input"
                                               placeholder="القيمة المالية" value="{{$one_lawsuit->lawsuit_value2}}"
                                               min="0"></div>
                                </div>
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <select id="currency2" name="currency2" class="form-control select2">
                                            <option value="1" {{($one_lawsuit->currency2==0)?"selected='selected'":""}}>
                                                اختر قيمة..
                                            </option>
                                            <option value="1" {{($one_lawsuit->currency2==1)?"selected='selected'":""}}>
                                                شيكل NIS
                                            </option>
                                            <option value="2" {{($one_lawsuit->currency2==2)?"selected='selected'":""}}>
                                                دولار US
                                            </option>
                                            <option value="3" {{($one_lawsuit->currency2==3)?"selected='selected'":""}}>
                                                دينار JOD
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="input-icon">
                                        ...
                                        <input name="judge" type="text" class="form-control input"
                                               placeholder="جهة الدعوى" value="{{$one_lawsuit->judge}}"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <input name="executive_file_no" type="text" class="form-control input-left"
                                               placeholder="" value="{{$one_lawsuit->executive_file_no}}">
                                        <span class="input-group-addon input-right">
                                                                            <i class="fa fa-cog"></i>
                                                                        </span>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <input name="prosecution_file_no" type="text"
                                               class="form-control input-left"
                                               placeholder="" value="{{$one_lawsuit->prosecution_file_no}}">
                                        <span class="input-group-addon input-right">
                                                                            <i class="fa fa-cog"></i>
                                                                        </span>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <input name="complaint_no" type="text" class="form-control input-left"
                                               placeholder="" value="{{$one_lawsuit->complaint_no}}">
                                        <span class="input-group-addon input-right">
                                                                            <i class="fa fa-cog"></i>
                                                                        </span>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <input name="noti_file_no" type="text" class="form-control input-left"
                                               placeholder="" value="{{$one_lawsuit->noti_file_no}}">
                                        <span class="input-group-addon input-right">
                                                                            <i class="fa fa-cog"></i>
                                                                        </span>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <textarea class="form-control" name="lawsuit_note"
                                              rows="3">{{$one_lawsuit->lawsuit_note}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" <?php echo $css ?> id="resutDv">
                            <div class="form-group">
                                <label class="col-md-6 control-label"> نتيجة الدعوى
                                    <span class="required"> * </span></label>
                                <div class="col-md-6">
                                    <div class="input-group">
                    ...
                    <div class="portlet-body form">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="input-icon input-group " id="remote">
                                    ...
                                    <input name="name" id="name" type="text"
                                           class="form-control typeahead select2_sample2 input-medium"
                                           placeholder="الاسم">
                                </div>
                            </div>
                        ...
                        <div class="row" style="display: none" id="wakelDv">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon input-group ">
                                    <i class="fa fa-user"></i>
                                    <input name="justice_name" id="justice_name" type="text" class="form-control"
                                           placeholder="الاسم">
                                </div>
                            </div>
                            {{--</div>--}}
        ...
        <div class="row " id="respondentsDiv">
            <div class="col-md-12">
                <!-- BEGIN SAMPLE FORM PORTLET-->
                <div class="portlet light ">
                    <div class="portlet-title">
                    ...
                    form1.validate({
                        ...
                        messages: { // custom messages for radio buttons and checkboxes
                            ...
                            lawyers: {
                                ...
                                minlength:
                                    jQuery.validator.format("At least {0} items must be selected")
                            }
                            ,
                            lawsuit_value:
                                {
