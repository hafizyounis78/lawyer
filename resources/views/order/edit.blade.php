        ...
        <div class="portlet box green">
            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                    ...
                    <input type="hidden" name="hdn_file_id" id="hdn_file_id" value="{{$one_order->file_id}}">
                    <input type="hidden" name="hdn_order_id" id="hdn_order_id" value="{{$one_order->id}}">
                        ...
                        <div class="col-md-6">
                            <div class="input-group date form_datetime" data-date=""
                                ...
                                <input type="text" name="order_date" id="order_date" size="40"
                                       class="form-control" dir="ltr" value="{{$one_order->order_date}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="icon-star"></i>
                                <input class="form-control" name="order_id" id="order_id" rows="3" value="{{$one_order->order_id}}"></input>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <textarea class="form-control" name="order_text" id="order_text" rows="3">{{$one_order->order_text}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="icon-book-open"></i>
                                <textarea class="form-control" name="comments"  id="comments" rows="3">{{$one_order->comments}}</textarea>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light ">
                    ...
                    <div class="portlet-body form">
                        ...
                        <input type="hidden" name="refernce_id" id="refernce_id" value="{{$one_order->id}}">
