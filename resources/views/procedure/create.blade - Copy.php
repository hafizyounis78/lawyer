        ...
        <div class="portlet box green">
            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                    ...
                    <input type="hidden" name="hdn_procd_id" id="hdn_procd_id" value="{{''}}">
                    <div class="form-group">
                        <label class="control-label col-md-3">وقت وتاريخ الإجراء</label>
                        <div class="col-md-4">
                            <div class="input-group date form_datetime" data-date=""
                                 data-date-format="dd/mm/yyyy hh:mm:ss">
                                <input type="text" name="prcd_date" id="prcd_date" size="16" readonly
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <textarea class="form-control" name="prcd_text" id="prcd_text" rows="3"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-group date form_datetime">
                                <input type="text" size="16" readonly class="form-control" dir="ltr" name="event_date"
                                       id="event_date">
                                <span class="input-group-btn">
                                                            <button class="btn default date-set" type="button">
                                                                <i class="fa fa-calendar"></i>
