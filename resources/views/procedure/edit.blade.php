...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="portlet box green">
            ...
            <div class="portlet-body form">
                ...
                {{Form::open(['url'=>url('procedure'),'class'=>'form-horizontal','method'=>"post","id"=>"procedure_form"])}}
                <input type="hidden" name="hdn_file_id" id="hdn_file_id" value="{{$one_procedure->file_id}}">
                <input type="hidden" id="hdn_procd_id" name="hdn_procd_id" value="{{$one_procedure->id}}">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3">وقت وتاريخ الإجراء</label>
                        <div class="col-md-6">
                            <div class="input-group date form_datetime" data-date="">
                                <input type="text" name="prcd_date" id="prcd_date" size="40"
                                        class="form-control" value="{{$one_procedure->prcd_date}}" dir="ltr">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">الإجراء</label>
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="icon-book-open"></i>
                                <textarea class="form-control" name="prcd_text" id="prcd_text"
                                          rows="3">{{$one_procedure->prcd_text}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <textarea class="form-control" name="comments"
                                          rows="3">{{$one_procedure->comments}}</textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-actions left">
                    <div class="row">
                        <div class=" col-md-9">
                            ...
                            <a href="{{url('/procedure')}}" class="btn grey-salsa btn-outline">عودة</a>
                        </div>
                    </div>
                </div>
                {{-- </form>--}}
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body form">
                                ...
                                <input type="hidden" name="smc_type" id="smc_type" value="1">
                                <input type="hidden" name="refernce_id" id="refernce_id" value="{{$one_procedure->id}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-icon">
                                            <i class="icon-book-open"></i>
                                            <textarea class="form-control" name="sms_text" id="sms_text"
                                                      rows="3"></textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="input-group date form_datetime">
                                        <input type="text" size="16" readonly class="form-control" dir="ltr"
    ...
    @push('js')
        ...
        <script>
            ...
            var procedureFormValidation = function () {
            ...
            procedureFormValidation.init();

            function procedureSubmit() {
                var form1 = $('#procedure_form');
                var error = $('.alert-danger', form1);
                var success = $('.alert-success', form1);

                var action = $('#procedure_form').attr('action');
                var hdn_file_id = $('#hdn_file_id').val();
                var formData = new FormData($('#procedure_form')[0]);
                        ...
                        success:
                            ...
                            function (data) {
                                if (data.success) {
                                    ...
                                    // $('#hdn_procd_id').val(data.procd_id);
                                    /*  $('#prcd_date').val('');
                                      $('#prcd_text').val('');
                                      $('#comments').val('');
                                      $('#sms_text').val('');
  */
            ...
            function reminderSubmit() {
                ...
                var hdn_file_id = $('#hdn_file_id').val();
                var hdn_procd_id = $('#hdn_procd_id').val();
                var formData = new FormData($('#reminder_form')[0]);
                formData.append('hdn_file_id', hdn_file_id);
                formData.append('hdn_event_id', hdn_procd_id),
