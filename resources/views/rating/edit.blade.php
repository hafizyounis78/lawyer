        ...
        <div class="portlet box green">
            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                    ...
                    <input type="hidden" id="hdn_master_id" value="{{$evalMaster->id}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <label class=" control-label"> {{$evalMaster->system_desc}}</label>
                        </div>
                    </div>
                </div>
                <div class="form-actions left">
                    <div class="row">
                        <div class=" col-md-9">
                            ...
                            <a href="{{url('/rating')}}" class="btn yellow-crusta btn-outline">عودة</a>
                        </div>
                    </div>
                </div>
            {{-- </form>--}}
