                    ...
                    <div class="portlet-body form">
                        <form role="form" class="form-horizontal">
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label class="control-label col-md-3">حالة المهمة</label>
                                        <div class="col-md-4">
                                            <select id="task_status_id" class="form-control select2" name="task_status_id">
                                                <option value="0">اختر قيمة..</option>
                                                <?php

                                                foreach ($task_statuses as $task_statuse) {

                                                    echo '<option value="' . $task_statuse->id. '">' . $task_statuse->desc . '</option>';
                                                }
            ...
            function view_Report() {
                ...
                $('#report_tbl').dataTable({
                    ...
                    'columns': [
                        ...
                        {data: 'statusColor', name: 'statusColor'},
                    ],
                    "language": {
                        "aria": {
