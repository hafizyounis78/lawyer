                    ...
                    <div class="portlet-body form">
                        <form role="form" class="form-horizontal">
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label for="multiple" class="control-label col-md-3">حالة التقييم</label>
                                        <div class="col-md-4">
                                            <select id="eval_status_id" name="eval_status_id" class="form-control select2">
                                                <option value="0">اختر ..</option>

                                                <?php

                                                foreach ($rateStatuses as $rateStatuse) {

                                                    echo '<option value="' . $rateStatuse->id . '">' . $rateStatuse->desc . '</option>';
                                                }
                ...
                $('#report_tbl').dataTable({
                    ...
                    'ajax': {
                        ...
                        "data": {
                            ...
                            'emp_id': $('#emp_id').val(),
                            'eval_id': $('#eval_id').val(),
                            'eval_status_id': $('#eval_status_id').val(),
                        }
                        ,
