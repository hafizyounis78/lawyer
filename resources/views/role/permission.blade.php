...
@section('content')
    ...
    <div class="page-content">
            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="col-md-3 control-label">اسم الصلاحية
                                    <span class="required"> * </span></label>
                                <div class="col-md-6">
                                    <div class="input-icon">
                                        <i class="icon-user"></i>
                                        <input id="display_name" name="display_name" type="text" class="form-control "
                                               placeholder="اسم الصلاحية" value=""></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <select id="menu_id" name="menu_id" class="form-control select2 ">
                                            ...
                                            foreach ($menus as $menu) {
                                                ...
                                                echo '<option value="' . $menu->id . '">' . $menu->menu_display_name . '</option>';
                                            }
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="col-md-3 control-label">ترتيب الصلاحية
                                    <span class="required"> * </span></label>
                                <div class="col-md-6 ">
        ...
        <div class="portlet box yellow-casablanca">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i>جدول انواع الصلاحيات
                </div>
                <div class="tools">
                    <a href="javascript:;" class="collapse"> </a>
