    ...
    <div class="page-content">
        ...
        <div class="portlet box green">
            ...
            <div class="portlet-body form">
                ...
                <input type="hidden" name="hdn_file_id" id="hdn_file_id" value="{{$one_session->file_id}}">
                <input type="hidden" id="hdn_session_id" name="hdn_session_id" value="{{$one_session->id}}">
                <div class="form-body">
                            ...
                            <div class="input-group">
                                <select id="prcd_id" name="prcd_id" class="form-control select2 ">
                                    ...
                                    foreach ($prcds as $prcd) {
                                        if($prcd->id==$one_session->prcd_id)
                                            $selected = 'selected="selected"';
                                        echo '<option value="' . $prcd->id . '" ' .$selected.'>' . $prcd->prcd_date . ' - ' . $prcd->prcd_text . '</option>';
                                    }
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-group  date date-picker" data-date-format="yyyy-mm-dd" >
                                <input type="text" class="form-control" readonly name="session_date" id="session_date" value="{{\Carbon\Carbon::parse($one_session->session_date)->format('Y-m-d')}}">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">تفصيل الجلسة</label>
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="icon-book-open"></i>
                                <textarea class="form-control" name="session_text" id="session_text"
                                          rows="3">{{$one_session->session_text}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <textarea class="form-control" name="comments"
                                          rows="3">{{$one_session->comments}}</textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-actions left">
                    <div class="row">
                        <div class=" col-md-9">
                            ...
                            <a href="{{url('/session')}}" class="btn grey-salsa btn-outline">عودة</a>
                        </div>
                    </div>
                </div>
                {{-- </form>--}}
