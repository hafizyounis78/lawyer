    ...
    <div class="page-content">
        ...
        <div class="portlet box red-haze">
            ...
            <div class="portlet-body form">
                ...
                {{Form::open(['url'=>url('task'),'class'=>'form-horizontal','method'=>"post","id"=>"task_form"])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group date form_datetime"
                                 data-date-format="dd/mm/yyyy hh:mm:ss" data-date-start-date="+0d">
                                <input type="text" name="task_date" id="task_date" size="40"  class="form-control" dir="ltr">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-icon">
                                ...
                                <textarea class="form-control" name="task_desc" id="task_desc" rows="3"></textarea>
                            </div>
                        </div>
                    </div>
