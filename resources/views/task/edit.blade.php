            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                        ...
                        <div class="col-md-6">
                            <div class="input-icon">
                                ...
                                <textarea class="form-control" name="task_desc" id="task_desc"
                                          rows="3">{{$one_task->task_desc}}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-3 control-label">حالة المهمة
                            <span class="required"> * </span></label>
                        <div class="col-md-6">
                            <div class="input-group">
                                <select id="task_status" name="task_status" class="form-control select2">
                                    ...
                                    foreach ($task_statuses as $task_statuse) {
                                        $selected = '';
                                        if ($one_task->task_status == $task_statuse->id)
                                            $selected = 'selected="selected"';
                                        echo '<option value="' . $task_statuse->id . '" ' . $selected . ' >'  . $task_statuse->desc . '</option>';
                                    }
