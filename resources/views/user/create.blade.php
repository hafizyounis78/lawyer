            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <label for="name" class=" col-md-3 control-label">الموظف</label>
                        <div class="col-md-4">
                            <select id="emp_id" name="emp_id" class="form-control select2" onchange="getEmpData();">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon input-group col-md-12">
                                ...
                                <input id="email" name="email" type="email" class="form-control "
                                       placeholder="البريد الإلكتروني" value="{{isset($one_user->email)}}"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon input-group col-md-12">
                                ...
                                <i class="fa fa-key"></i>
                                <span class="help-block"> 6 حروف او ارقام على الاقل </span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input id="address" name="address" type="text" class="form-control "
                                       placeholder="العنوان" disabled value="{{isset($emp->address)}}"></div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input id="mobile" name="mobile" type="text" class="form-control "
                                       placeholder="جوال" disabled value="{{isset($emp->mobile)}}"></div>
                        </div>
                    </div>
                ...
                <div class="form-actions left">
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <a href="{{url('/user')}}" class="btn  grey-salsa btn-outline">عودة</a>
                        </div>
                    </div>
                </div>
            {{-- </form>--}}
