                        ...
                        <div class="col-md-4">
                            <div class="input-icon input-group col-md-12">
                                ...
                                <input id="email" name="email" type="email" class="form-control "
                                       placeholder="البريد الإلكتروني" data-id="{{$one_user->email}}" value="{{$one_user->email}}"> </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="input-icon input-group col-md-12">
                                ...
                                <input name="address" type="text" class="form-control "
                                       placeholder="العنوان" disabled value="{{$emp->address}}"> </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon input-group col-md-12">
                                ...
                                <input name="phone" type="text" class="form-control"
                                       placeholder="جوال" disabled  value="{{$emp->mobile}}"> </div>
                        </div>
                    </div>
